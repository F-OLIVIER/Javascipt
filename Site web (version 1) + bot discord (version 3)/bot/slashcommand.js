...
export async function createCommands() {
    ...
    await client.application.commands.create({
        name: 'nombre_inscription_prochaine_gvg',
    ...
    await client.application.commands.create({
        name: 'non_inscrit_gvg',
        description: "Affiche la lists des pseudo des joueurs non inscrit pour la prochaine GvG (réservé aux officier)",
    });
